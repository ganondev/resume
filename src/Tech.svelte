...
<div class="bars">
    ...
    <SkillBar percentage={88} tools={['MS SQL', 'NoSQL', 'Oracle', 'Redis', 'DynamoDB', 'Redshift']}>Databases</SkillBar>
    <SkillBar percentage={90} tools={['Bash', 'AWS', 'Kafka', 'Git', 'CI/CD', 'Serverless', 'Kubernetes']}>Infra</SkillBar>
    ...
    <SkillBar percentage={0} tools={['Agile', 'Debugging', 'JWT', 'GraphQL', 'XSL', 'IAM', 'SSO', 'DevOps']}>Other</SkillBar>
